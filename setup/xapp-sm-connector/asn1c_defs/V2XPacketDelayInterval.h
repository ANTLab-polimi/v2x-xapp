...
#ifndef	_V2XPacketDelayInterval_H_
#define	_V2XPacketDelayInterval_H_
...
typedef struct V2XPacketDelayInterval {
	long	lowerInterval;
	long	upperInterval;
...
#endif	/* _V2XPacketDelayInterval_H_ */
