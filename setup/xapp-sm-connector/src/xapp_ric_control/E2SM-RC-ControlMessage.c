...
// 	{ 0, 0 },
// 	-1};
// asn_per_constraints_t asn_PER_type_E2SM_RC_ControlMessage_constr_1 CC_NOTUSED = {
...
// modified
asn_per_constraints_t asn_PER_type_E2SM_RC_ControlMessage_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  2,  2,  0,  2 }	/* (0..0,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
// end modification
asn_TYPE_member_t asn_MBR_E2SM_RC_ControlMessage_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct E2SM_RC_ControlMessage, choice.v2xSchedulingMessage_Format),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_V2X_Scheduling_All_UsersPlmn,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"v2xSchedulingMessage-Format"
		},
	// end modification
};
static const asn_TYPE_tag2member_t asn_MAP_E2SM_RC_ControlMessage_tag2el_1[] = {
	...
	{ (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* v2xScheduling */
	// end modification
};

asn_CHOICE_specifics_t asn_SPC_E2SM_RC_ControlMessage_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_E2SM_RC_ControlMessage = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_E2SM_RC_ControlMessage_constr_1, CHOICE_constraint },
