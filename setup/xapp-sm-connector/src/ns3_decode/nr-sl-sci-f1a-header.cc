...
// modified
void
NrSlSciF1aHeader::SerializeForE2 (Buffer::Iterator i) const
{
  // Buffer::Iterator i = start;
  // NS_LOG_FUNCTION(this);
...
uint32_t
NrSlSciF1aHeader::DeserializeForE2 (Buffer::Iterator i)
{
  // Buffer::Iterator i = start;
...
uint32_t
NrSlSciF1aHeader::GetSerializedSizeForE2 (void) const
{
  uint32_t totalSize = 0; //bytes
